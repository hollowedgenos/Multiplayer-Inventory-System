...
### Contribution Notes
I  was responsible for the creation of LocalInventory.cs script; [Jalen Carney](https://github.com/JalenCarney) contributed with the tracking of money in the inventory. 
ItemData.cs was also created by Jalen Carney, however I made major structural rewrites to the script. I created the WorldItem.cs script, but 
